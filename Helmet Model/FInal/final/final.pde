...
/*
 * ht1632_writebits
 * Write bits (up to <IMG class=wp-smiley alt=8) src="http://timewitharduino.com/wp-includes/images/smilies/icon_cool.gif"> to h1632 on pins HT1632_DATA, HT1632_WRCLK
...
void displayScrollingLine()
{
  ...
  int animation=random(MAXANIMATIONS);
